...
public class FacebookBarBehaviorDefiner: FlexibleHeightBarBehaviorDefiner {
    ...
    public var thresholdFromTop: CGFloat {
        get {
    ...
    public var thresholdNegativeDirection: CGFloat {
        get {
    ...
    public var thresholdPositiveDirection: CGFloat {
        get {
    ...
    public override init() {
        ...
        addSnappingPositionProgress(0.0, _forProgressRangeStart: 0.0, end: 40.0/(105.0 - statusBarHeight))
        addSnappingPositionProgress(1.0, _forProgressRangeStart: 40.0/(105.0 - statusBarHeight), end: 1.0)
    ...
    public func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        if let flexHeightBar = flexibleHeightBar {
            ...
            if (scrollView.contentOffset.y + scrollView.contentInset.top) >= -statusBarHeight && scrollView.contentOffset.y <= (scrollView.contentSize.height - scrollViewViewportHeight) {
