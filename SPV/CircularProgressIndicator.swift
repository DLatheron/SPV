...
public enum CircularProgressIndicatorGlowMode {
    case forward, reverse, constant, noGlow
}

@IBDesignable
public class CircularProgressIndicator: UIView, CAAnimationDelegate {
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        var glowMode: CircularProgressIndicatorGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: CircularProgressIndicatorGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
